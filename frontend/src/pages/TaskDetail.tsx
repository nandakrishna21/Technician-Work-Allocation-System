        ...
        <div className="flex justify-between items-start mb-6">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              ...
              {new Date(task.createdAt).toLocaleString('en-IN', { timeZone: 'Asia/Kolkata', hour12: false })}
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            {task.completedAt && (
              <p className="text-sm text-gray-500">
                Completed on: {new Date(task.completedAt).toLocaleString('en-IN', { timeZone: 'Asia/Kolkata', hour12: false })}
              </p>
            )}
            <div className="flex gap-3">
              <button
              ...
              >
                ...
                <span className="text-xs text-gray-400">
                  {assignment.acceptedAt
                    ? `Accepted: ${new Date(assignment.acceptedAt).toLocaleString('en-IN', { timeZone: 'Asia/Kolkata', hour12: false })}`
                    : `Assigned: ${new Date(assignment.assignedAt).toLocaleString('en-IN', { timeZone: 'Asia/Kolkata', hour12: false })}`}
                </span>
              </div>
            ))}
          </div>
            ...
            <div key={log.id} className="flex items-start gap-3 pb-3 border-b last:border-0">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-400 mt-0.5">
                  {new Date(log.createdAt).toLocaleString('en-IN', { timeZone: 'Asia/Kolkata', hour12: false })}
                </p>
              </div>
            </div>
          ))}
